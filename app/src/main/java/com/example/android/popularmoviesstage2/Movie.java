...
public class Movie implements Parcelable {
    ...
    // https://stackoverflow.com/questions/35482440/how-to-implement-parcelable-in-a-class-with-a-inner-class-too
    @SerializedName("id")
    public Integer id;
    ...
    public String toString() {
        return  "Title: " + title + ", Release date: "  + releaseDate + ", Vote average: "  + voteAverage;
    }
